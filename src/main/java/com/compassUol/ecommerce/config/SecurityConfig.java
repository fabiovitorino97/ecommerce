package com.compassUol.ecommerce.config;

import com.compassUol.ecommerce.security.JwtTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/users/**", "/api/permissions", "/swagger-ui/**", "/v3/api-docs/**").permitAll()
